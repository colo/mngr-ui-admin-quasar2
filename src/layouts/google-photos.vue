    ...
    <q-page-container class="GPL__page-container">
      ...
      <q-page-sticky v-if="$q.screen.gt.sm" expand position="left">
        <div class="fit q-pt-xl q-px-sm column">
          <q-btn v-for="link in links2" :key="link.text" round flat color="grey-8" stack no-caps size="26px" class="GPL__side-btn" :to="link.to">
  ...
  data () {
    return {
      ...
      links2: [
        ...
        { icon: 'dashboard', text: 'Munin', to: '/munin' }
      ],
      links3: [
